...
public static class Ext
{
    ...
    {
        DrawTexturePro(t, new Raylib_CsLo.Rectangle(0, 0, t.width, t.height), new Raylib_CsLo.Rectangle(pos.X, pos.Y, t.width, t.height),
    ...
    /// <summary>
    /// Returns the center of 2 <see cref="Vector2"/>s (as if it was a <see cref="Raylib_CsLo.Rectangle"/>) as a <see cref="Vector2"/>
    /// </summary>
    /// <param name="pos">position of '<see cref="Raylib_CsLo.Rectangle"/>'</param>
    /// <param name="size">size of '<see cref="Raylib_CsLo.Rectangle"/>'</param>
    /// <returns>the center of the given <see cref="Raylib_CsLo.Rectangle"/></returns>
    /// <remarks>like the <see cref="Raylib_CsLo.Rectangle"/>'s Center, but optimized for V2</remarks>
    ...
    /// <inheritdoc cref="DrawTextRec(Font,string,Rectangle,Color,float,float,bool)"/>
    ...
    public static void DrawTextRec(this Font font, string text, Rectangle rect, Color tint, float fontSize,
        float spacing, bool wordWrap, int selectStart, int selectLength, Color selectTint, Color selectBackTint)
    {
        Core.DrawTextRec(font, text, rect, tint, fontSize, spacing, wordWrap, selectStart, selectLength, selectTint, selectBackTint);
    }
}
